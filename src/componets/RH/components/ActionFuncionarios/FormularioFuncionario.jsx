...
import { getSchemaFuncionario } from "./schemaValidarFuncionario";
...
export const FormularioFuncionario = ({
  modo,
  handleClose,
  usuarioLogado,
  optionsModulos,
  ...
  } = useFuncionarioForm({ modo, handleClose, usuarioLogado, optionsModulos, refetch, dadosAtualizarFuncionarios, handleClick });
  ...
  const handleValidatedSubmit = async () => {
    try {
      const dadosParaValidar = {
        ...
        cpf: isCriar ? cpfFuncionario : cpf,
        ...
        descontoConvenioFuncionario: valorDesconto,
        execaoDescFuncionario: excecao,
        situacaoFuncionario: situacaoSelecionada,
      };

      await getSchemaFuncionario(modo).validate(dadosParaValidar, { abortEarly: false });
      onSubmit();
        ...
        <form onSubmit={handleSubmit(handleValidatedSubmit)}>
          <div className="row">
            <div className="col-sm-6 col-md-6 col-xl-6">
              <label className="form-label" htmlFor="empresaFuncionario">{isCriar ? 'Empresa *' : 'Loja '}</label>
              <Select
            ...
            <div className="col-sm-6 col-md-6 col-xl-6">
              <label className="form-label" htmlFor="funcaoFuncionario">{isCriar ? 'Função *' : 'Função'}</label>
              <Select
                className="basic-single"
                classNamePrefix={"select"}
          ...
          <div className="row mt-4">
            <div className="col-sm-6 col-md-6 col-xl-6">
              <label className="form-label">{isCriar ? 'Tipo *' : 'Tipo'}</label>
              <Select
                className="basic-single"
                classNamePrefix={"select"}
          ...
          <div className="row mt-4">
            <div className="col-sm-6 col-xl-6">
              <label htmlFor="">{isCriar ? 'Localização *' : 'Localização'}</label>
              <Select
                className="basic-single"
                classNamePrefix={"select"}
            ...
            <div className="col-sm-6 col-xl-6">
              <label className="form-label">{isCriar ? 'Categoria de Contratação *' : 'Categoria de Contratação'}</label>
          ...
          <div className="row mt-4">
              ...
              <Controller
                ...
                render={() => (
                  <FormField
                    ...
                    clearErrors={clearErrors}
                    value={valorDesconto}
                    onChangeModal={e => isCriar
                      ? setValorDesconto(formatarMoeda(e.target.value))
                      : handlePorcentoDesconto(Number(e.target.value))
                    }
                  />
                )}
              />
            ...
            {isCriar ? (
              <div className="col-sm-6 col-xl-6" style={{ alignItems: 'center', display: 'flex', width: '100%' }}>
                <div className="form-check">
                  <input
                    type="radio"
                    className="form-check-input"
          ...
          <div className="form-group mt-4">
            <div className="row">
              ...
              <div className={isCriar ? "col-sm-6 col-xl-6" : "col-sm-4 col-md-4 col-xl-4"}>
