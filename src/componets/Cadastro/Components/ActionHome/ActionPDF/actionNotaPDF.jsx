...
export const ActionNotaPDF = ({ dadosPedido, dadosDetalhePedido }) => {
    ...
    console.log(dadosPedido[0], 'dadosPedido[0]')
    const logosEmpresas = [
        '../img/tesoura.png',      
        '../img/magazine.png',     
        '../img/yorus.png',        
                ...
                <table width="100%" className="bordasimples">
                    <tbody>
                        <tr>
                            ...
                            <td className="tdPdf">
                                Bairro: <br /><p className="tdPdf">{dadoPrincipal?.BAIRROFORN}</p>
                            </td>
                            <td className="tdPdf">
                                Transportadora/Telefone: <br /><p className="tdPdf">{dadoPrincipal?.NOMETRANSPORTADORA} - </p>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table width="100%" className="bordasimples">
                    <tbody>
                        <tr>
                            ...
                            <td className="tdPdf">
                                Desc. I (%): <br /><p className="tdPdf">{formatMoeda(toFloat(dadoPrincipal?.DESCPERC01))}</p>
                            </td>
                            <td className="tdPdf">
                                Desc. II(%): <br /><p className="tdPdf">{formatMoeda(toFloat(dadoPrincipal?.DESCPERC02))}</p>
                            </td>
                            <td className="tdPdf">
                                Desc. III(%): <br /><p className="tdPdf">{formatMoeda(toFloat(dadoPrincipal?.DESCPERC03))}</p>
                            </td>
                        </tr>
                    </tbody>
                </table>
