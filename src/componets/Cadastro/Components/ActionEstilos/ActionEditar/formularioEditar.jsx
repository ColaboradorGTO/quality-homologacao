...
export const FormularioEditarEstilos = ({dadosDetalheEstilos }) => {
    ...
    // console.log(descricao, 'formulario')
    // console.log(subGrupoSelecionado)
        ...
        <Fragment>
            <form action="">
                ...
                <FooterModal
                    ...
                    onClickButtonCadastrar={atualzarEstilo}
